...
class SeedBuiltInsTest extends TestCase
{
    ...
    public function test_built_in_sections_and_fields_seeded(): void
    {
        ...
        foreach (['category' => ['Delhi', 'Outside'], 'student_response' => ['Ready', 'Not Interested', 'Needs Time'], 'plan' => ['Sitting', 'Counselling Online', 'Counselling Offline']] as $key => $expectedValues) {
            $field = StudentField::where('key', $key)->first();
