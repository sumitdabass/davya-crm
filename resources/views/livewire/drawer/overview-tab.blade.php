<div>
    ...
    @php($rowStyle = 'display: grid; grid-template-columns: 110px 1fr; gap: 10px; font-size: var(--fs-12); padding: 4px 0;')
    @php($labelStyle = 'color: var(--text-sub);')
    @php($emptyStyle = 'color: var(--text-sub);')
    <div class="davya-section-card">
